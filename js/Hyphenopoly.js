  ...
  ((H) => {
      ...
      function processElements(el, pLang, sel, isChild = false) {
        ...
        if (langDef === "H9Y") {
          ...
          event.fire(
            "error",
            Error(
              `Element with '${eLang}' found, but '${eLang}.wasm' not loaded. Check language tags!`,
            ),
          );
        }
    ...
    function hyphenate(lang, sel, entity) {
      ...
      function hyphenateText(text) {
        ...
        let tn = text.replace(regExpWord, createWordHyphenator(lo, lang, sel));
    ...
    function instantiateWasmEngine(heProm, lang) {
      ...
      function handleWasm(res) {
        ...
        heProm.l.forEach((l) => {
          prepareLanguagesObj(
            l,
            encloseHyphenateFunction(exp.mem.buffer, exp.hyphenate),
